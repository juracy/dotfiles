...
-- DMS-RULE: id=wr_1783715728030718495, name=Cosmic Portal
hl.window_rule({ match = { class = "^com.system76.CosmicFilesDialog$" }, float = true })

-- DMS-RULE: id=wr_1783715758260405382, name=Dank Linux
